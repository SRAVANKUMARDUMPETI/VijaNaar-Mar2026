# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 22:45:23 2026
...
scores = model_selection.cross_val_score(bag_tree_estimator1, X_train, y_train, cv = 2)
bag_tree_estimator1.fit(X_train, y_train)
bag_tree_estimator1.score(X_train, y_train)
print(scores)
print(scores.mean())
